...
def train_sketch_rnn(args):
    dict_loss = {"Train_Loss" : [], "Valid_Loss" : []}
    list_Epochs = []
    ...
    for epoch in range(args.num_epochs):
        ...
        dict_loss["Valid_Loss"].append(val_loss)
        print(dict_loss)
        ...
        model.conditional_generation(epoch, args.max_seq_len, args.save_image_dir, args.num_epochs)
        time.sleep(0.5) # avoids progress bar issue

    #get loss through csv file
    # dataframe = pd.DataFrame(dict_loss, index = list_Epochs)
    # dataframe.to_csv("/content/drive/MyDrive/CS470/Final/Sketch_generation/Sketch-RNN-master/apple_0.5_0.1_lstm_hyper.csv", sep = ',', na_rep = "NaN")
