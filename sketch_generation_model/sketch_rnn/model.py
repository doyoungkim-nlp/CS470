...
class SketchRNN(nn.Module):
  ...
  #------------------------------------------------------------------------#
    def conditional_generation(self, epoch, max_len, save_image_dir, num_epochs):
        ...
        make_image(sequence, epoch, save_image_dir, num_epochs)
...
# ---- Image Making ---- #
def make_image(sequence, epoch, save_image_dir, num_epochs, name='_output_'):
